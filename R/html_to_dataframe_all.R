...
#'
#' @param filepath A file path where a user saved HTML files containing the search results from the Ethnic NewsWatch database. This input should be a string vector. 
